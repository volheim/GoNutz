...
namespace Go_Nutz
{
    partial class GameWorld
    {
        public void SetupWorld()
        {
            ...
            #region HomeTrees
            HomeTree Hometree1 = (new HomeTree(new Vector2(100f, 250f), @"Images\stumpHome.png", 0.1f));
            HomeTree2 Hometree2 = (new HomeTree2(new Vector2(1000f, 250f), @"Images\stumpHome.png", 0.1f));
            #endregion HomeTrees
            #region Nuts
