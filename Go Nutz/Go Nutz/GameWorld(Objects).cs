...
namespace Go_Nutz
{
    partial class GameWorld
    {
        ...
        public static void GenerateHomeTree(int x, int y)
        {
            if(homeNumber == 0)
            {
                Hometree1 = (new HomeTree(new Vector2(x, y), @"Images\stumpHome.png", 1.2f, Player1, true));
            ...
            {
                Hometree2 = (new HomeTree(new Vector2(x, y), @"Images\stumpHome.png", 1.2f, Player2, true));
        ...
        public static void PlacePlayer(int x, int y)
        {
            if (playerNumber == 0)
            {
                Player1 = new Player(new Vector2(x, y), @"Images\ChipmunkWalk\ChipmunkWalk01.png;Images\ChipmunkWalk\ChipmunkWalk02.png;Images\ChipmunkWalk\ChipmunkWalk03.png;Images\ChipmunkWalk\ChipmunkWalk04.png", 10, 10, 2, 0.55f, new Keys[6] { Keys.A, Keys.S, Keys.D, Keys.W, Keys.Q, Keys.E });
            ...
            else if (playerNumber == 1)
            {
                ...
                Hometree2.HometreePlayer = Player2;
                objects.Add(Player2);
